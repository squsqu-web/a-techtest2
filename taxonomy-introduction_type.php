...
<div
  ...
  <nav class="breadcrumb">
    ...
    <a href="<?php echo esc_url(get_post_type_archive_link('introduction')); ?>">
      各園のご紹介
    </a>
                    ...
                    <?php else : ?>
                      ...
                      <img
                        src="<?php echo esc_url(
                          get_template_directory_uri() . '/img/no-image.webp'
                        ); ?>"
  ...
  <div class="p-recruit__inner">
    ...
    <div class="p-recruit__link-wrap inview">
      ...
      <a
        ...
        class="p-recruit__link-info c-button u-hover">
      ...
      <a
        href="<?php echo esc_url(home_url('/recruit')); ?>"
        class="p-recruit__link-entry c-button u-hover">
